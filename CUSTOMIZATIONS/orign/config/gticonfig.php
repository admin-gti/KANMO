<?php 
    ...
    define('SYSCONFIG_KANMO_API_SHIPPINGLABEL','api/shipment/Staging/V1/ShipmentLabel?ShipmentID=');
    define('SYSCONFIG_KANMO_API_DISPATCHNOTE','api/shipment/Staging/V1/ShipmentLabel?ShipmentID=');
    /*------------------------------------------------------------------------*/
    ...
    define('SYSCONFIG_ENGINEDBPATH','C:\Program Files (x86)\Genie Technologies Inc\Kanmo Omnichannel Orders\DB\prismSO_db.db');
