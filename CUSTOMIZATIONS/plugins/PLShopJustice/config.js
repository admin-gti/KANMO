ButtonHooksManager.addHandler(['after_posOnlineBasket'], ['$modal', 'ModelService', '$q', '$window', 'NotificationService', 'LoadingScreen', '$state', 'DocumentPersistedData', '$http', function($modal, ModelService, $q, $window, NotificationService, LoadingScreen, $state, DocumentPersistedData, $http) {
    ...
    LoadingScreen.Enable = 1, ModelService.get('Document', { sid: activeDocumentSid }).then(function(doc) {
...
// Select Items from Online Store
