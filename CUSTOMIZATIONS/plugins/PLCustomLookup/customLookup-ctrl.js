...
//        console.log(sFilter);
           ...
           i.Enable = 1;
        a.documents = '';
        b.get("/plugins/PLCustomLookup/customlookup.php?"+sFilter+"&type=1").then(function(data, status) {
...
//                            infoData += "\"order_changed_flag\":\"0\"";
                        ...
                        console.log("/prism.shtml#/register/pos/docs/"+localStorage.getItem('lookupSID')+"#searchTransactionItemsResult0");
                        window.location.href = "/prism.shtml#/register/pos/docs/"+localStorage.getItem('lookupSID')+"#searchTransactionItemsResult0";
                        e.dismiss();
                        deferred.resolve();
                        return deferred.promise;
