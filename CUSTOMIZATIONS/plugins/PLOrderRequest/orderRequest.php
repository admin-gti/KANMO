...
//    $conn->debug = true;
    ...
    if (TRUE == $conn){
        ...
        $flds[] = "b.st_primary_phone_no st_mobile";
        $flds[] = "b.st_email";
        $flds[] = "a.ship_date";
...
//                    }
                    ...
                    $d['amount']         = number_format($totalamt, 6, '.','');
...
//                curl_close($curl);
                ...
                $soDeptAmt = json_decode($responseA, true);
//                echo "<pre>";
//                print_r($responseA);
//                echo "</pre>";
//                echo "<br/>";
//                echo "<pre>";
//                print_r("https://".$_SERVER['SERVER_NAME']."/v1/rest/document/".$soDeptAmt[0]['sid']."?filter=row_version,eq,".$soDeptAmt[0]['row_version']);
//                echo "</pre>";
//                echo "<br/>";
                $b['so_deposit_amt'] = '0';
                
    //            
                $dataA =  "[".json_encode($b, JSON_UNESCAPED_SLASHES)."]";
//                $curlA = curl_init();

                curl_setopt_array($curl, array(
                    CURLOPT_URL => "https://".$_SERVER['SERVER_NAME']."/v1/rest/document/".$soDeptAmt[0]['sid']."?filter=row_version,eq,".$soDeptAmt[0]['row_version'],
                    CURLOPT_RETURNTRANSFER => true,
                    CURLOPT_ENCODING => "",
                    CURLOPT_MAXREDIRS => 10,
                    CURLOPT_SSL_VERIFYHOST => 0, //NEED TO REMOVE THIS AFTER DEPLOYMENT OF LIVE
...
//                }
                ...
                $y['deposit_amt_taken'] = '0';
    //            
                $dataB =  "[".json_encode($y, JSON_UNESCAPED_SLASHES)."]";
//                $curlB = curl_init();

                curl_setopt_array($curl, array(
                    CURLOPT_URL => "https://".$_SERVER['SERVER_NAME']."/v1/rest/document/".$soDeptAmt[0]['sid']."?filter=row_version,eq,".$DeptAmtTaken[0]['row_version'],
                    CURLOPT_RETURNTRANSFER => true,
                    CURLOPT_ENCODING => "",
                    CURLOPT_MAXREDIRS => 10,
                    CURLOPT_SSL_VERIFYHOST => 0, //NEED TO REMOVE THIS AFTER DEPLOYMENT OF LIVE
...
//                }
                ...
                $x['order_balance_due'] = '0';
    //            
                $dataC =  "[".json_encode($x, JSON_UNESCAPED_SLASHES)."]";
//                $curlC = curl_init();

                curl_setopt_array($curl, array(
                    CURLOPT_URL => "https://".$_SERVER['SERVER_NAME']."/v1/rest/document/".$soDeptAmt[0]['sid']."?filter=row_version,eq,".$OrdBalDue[0]['row_version'],
                    CURLOPT_RETURNTRANSFER => true,
                    CURLOPT_ENCODING => "",
                    CURLOPT_MAXREDIRS => 10,
                    CURLOPT_SSL_VERIFYHOST => 0, //NEED TO REMOVE THIS AFTER DEPLOYMENT OF LIVE
...
//                }
                ...
                $c['due_amt'] = '0';
    //            
                $dataD =  "[".json_encode($c, JSON_UNESCAPED_SLASHES)."]";
//                $curlD = curl_init();

                curl_setopt_array($curl, array(
                    CURLOPT_URL => "https://".$_SERVER['SERVER_NAME']."/v1/rest/document/".$soDeptAmt[0]['sid']."?filter=row_version,eq,".$DueAmt[0]['row_version'],
                    CURLOPT_RETURNTRANSFER => true,
                    CURLOPT_ENCODING => "",
                    CURLOPT_MAXREDIRS => 10,
                    CURLOPT_SSL_VERIFYHOST => 0, //NEED TO REMOVE THIS AFTER DEPLOYMENT OF LIVE
...
//                }
                ...
                $v['status'] = '4';
    //            
                $dataE =  "[".json_encode($v, JSON_UNESCAPED_SLASHES)."]";
//                $curlE = curl_init();

                curl_setopt_array($curl, array(
                    CURLOPT_URL => "https://".$_SERVER['SERVER_NAME']."/v1/rest/document/".$soDeptAmt[0]['sid']."?filter=row_version,eq,".$finalStat[0]['row_version'],
                    CURLOPT_RETURNTRANSFER => true,
                    CURLOPT_ENCODING => "",
                    CURLOPT_MAXREDIRS => 10,
                    CURLOPT_SSL_VERIFYHOST => 0, //NEED TO REMOVE THIS AFTER DEPLOYMENT OF LIVE
