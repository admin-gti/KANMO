SideButtonsManager.addButton({
    ...
    handler: ['$modal', '$q', '$stateParams', 'ResourceNotificationService', '$window', 'NotificationService', 'LoadingScreen', '$state', 'DocumentPersistedData', '$http', 'ModelService', 'prismSessionInfo', function($modal, $q, $stateParams, RN, $window, NotificationService, LoadingScreen, $state, DocumentPersistedData, $http, ModelService, prismSessionInfo) {
        
//        console.log(prismSessionInfo.get());
