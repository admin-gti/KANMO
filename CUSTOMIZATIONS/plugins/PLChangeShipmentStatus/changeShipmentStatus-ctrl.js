...
//            console.log(url);
            ...
            o.all(promises).then(function(){
                NotificationService.showSuccessfulMessage('Updated!', 'Shipment Status has been Updated!');
                setTimeout(function(){
...
//                promises.push(deferred.resolve());
   ...
   a.view = function() {
       var sid = $("#orderSID").val();
        window.location.href = "/prism.shtml#/register/pos/docs/"+sid+"#searchTransactionItemsResult0";
        e.dismiss();
        deferred.resolve();
