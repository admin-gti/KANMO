...
//            console.log(a);
    ...
    //                                deferred.resolve();
                        ...
                        LoadingScreen.Enable = 1,$.ajax({
                            url: "/plugins/PLChangeStat/changeOrder.php"
                            ,type: "GET"
                            ,data: {sid:$stateParams.document_sid,type:4}
                            ,success: function(ads){
                            ...
                            if (ads>0) {
                                    $.ajax({
                                        url: "/plugins/PLChangeStat/changeOrder.php"
                                        ,type: "GET"
                                        ,data: {sid:$stateParams.document_sid,an:auth_nonce,at:auth_timestamp,s:oauthSignatureCreateShip,type:1}
                                        ,success: function(msg){
                ...
                //                            } else {
                                                ...
                                                var httpMethod = 'GET',
                                                    url = vURL+'Order/'+merchantID+'/'+a.data[0].notes_general+'/Shipments',
                                                    parameters = {
                                                    oauth_consumer_key : consumer_key,
                                                    oauth_nonce : auth_nonce,
                                                    oauth_timestamp : auth_timestamp,
                                                ...
                                                encodedSignaturegetShipment = oauthSignature.generate(httpMethod, url, parameters, consumerSecret, '');
                                                 ...
                                                 $.ajax({
                                                    url: "/plugins/PLChangeStat/changeOrder.php"
                                                    ,type: "GET"
                                                    ,data: {sid:$stateParams.document_sid,an:auth_nonce,at:auth_timestamp,s:encodedSignaturegetShipment,type:2,id:a.data[0].notes_general}
                                                    ,success: function(msgs){
                                                        ...
                                                        $.ajax({
                                                            url: "/plugins/PLChangeStat/changeOrder.php"
                                                            ,type: "GET"
                                                            ,data: {sid:$stateParams.document_sid,an:auth_nonce,at:auth_timestamp,s:encodedSignatureUpdateShipStat,type:3,data:msgs.Shipments[0].ShipmentId}
                                                            ,success: function(msgss){    


    //                                                            $http.get('v1/rest/document?cols=*&filter=sid,eq,'+$stateParams.document_sid,{headers: {"Auth-Session": sessionStorage.getItem("PRISMAUTH")}}).then(function(docs){
    //                                                                var datapost = "[{";
    //                                                                    datapost += "\"udf_string2\":\"DELIVERED\"";
    //                                                                    datapost += "}]";
    //
    //                                                                return $http.put("v1/rest/document/"+$stateParams.document_sid+"?filter=row_version,eq,"+docs.data[0].row_version,datapost,{headers: {"Auth-Session": sessionStorage.getItem("PRISMAUTH")}}).success(function(){});
                                                                    LoadingScreen.Enable = !1,
                                                                    deferred.resolve();
    //                                                            });
                                                            }
